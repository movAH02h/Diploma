...
Отвечай простым текстом без форматирования. Ответ должен быть на языке транскрибированного аудио.
...
ВАЖНО: Не используй Markdown-разметку (**, *, #, -, _ и т.д.). Используй только обычный текст.
Отвечай простым текстом без форматирования.Ответ должен быть на языке транскрибированного аудио. Для списка используй нумерацию (1., 2., 3. и т.д.).
...
ВАЖНО: Не используй Markdown-разметку (**, *, #, -, _ и т.д.). Используй только обычный текст.
Отвечай простым текстом без форматирования на том языке, на котором тебе задали вопрос.
