...
#### Техническая спецификация, требуемое окружение и приграммы:
1. OC Linux Ubuntu 22.04
2. VSCode
3. Переменная окружения HF_TOKEN=<hugging_face_token>
